...
@Component({
  ...
  template: `
    ...
    <g mask="url(#a)">
      ...
      <svg:path fill="#496e2d" d="M0 0h144v512H0z" />
      ...
      />
      <svg:path fill="#ffda44" d="m234 186-12 11v11l18-9c3-1 3-5 1-7z" />
      <svg:circle cx="172" cy="275" r="8" fill="#ffda44" />
      <svg:circle cx="189" cy="302" r="8" fill="#ffda44" />
...
export class SiMxFlagIcon implements OnInit {
