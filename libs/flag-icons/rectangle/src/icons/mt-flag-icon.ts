...
@Component({
  ...
  template: `
    ...
    >
      ...
      <svg:path
        stroke-width=".5"
        d="M158.1 135.1c.4.3.4 0 1.1-.2s1.3.4 1 1q-.4 1 .6 1.2c1 .2 1-.7 1.2-1q.3-.3.7-.7c.2-.8 1-.6 1.5-.5m1-1.9c-.3.2-1.2-.5-1.4-1.1q-.3-1.3-1.8-1.4c-1.5-.1-3 .6-3.3 1.7l-.3 1.7q-.6 0-.7.2l-.1.8m-6.3 6.3 2-1"
      />
      <svg:path
        stroke-width=".3"
