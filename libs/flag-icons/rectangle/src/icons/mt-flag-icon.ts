...
@Component({
  ...
  imports: [],
  template: `
    <svg:path fill="#fff" stroke-width=".00818411" d="M0 0h640v480H0Z" />
    <svg:path fill="#cf142b" stroke-width=".00818411" d="M320 0h320v480H320Z" />
    <svg:g
      fill="#fff"
      stroke="#000"
      stroke-width="96"
    ...
    <svg:g
      ...
      stroke-width="36"
    >
      <svg:path stroke-width=".7" d="M137.9 185.8a588.3 588.3 0 0 1 48 0" />
      <svg:path
        stroke-width=".4"
