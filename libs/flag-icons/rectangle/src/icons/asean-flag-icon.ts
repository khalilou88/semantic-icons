...
@Component({
  selector: 'svg[si-asean-flag-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path fill="#0039a6" stroke-width="4.52548" d="M0 0h640v480H0z" />
    <svg:circle cx="320" cy="240" r="144" fill="#fff" stroke-width="4.8" />
    <svg:circle cx="320" cy="240" r="137.3" fill="#ed2939" stroke-width="4.8" />
    ...
    <svg:g id="asean-a">
      ...
      <svg:path
        fill="#f9e300"
        d="M87 35.2V35h-2.4v.3c0 2-.4 9-4.3 14.7 4 5.7 4.3 12.7 4.3 14.7v.3H87v-.2c0-2-.5-9.3-5.8-14.8a22 22 0 0 0 5.8-14.8"
        transform="translate(-40)scale(4.8)"
      />
      <svg:path
        fill="#f9e300"
