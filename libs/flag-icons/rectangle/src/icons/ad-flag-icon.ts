  ...
  template: `
    ...
    <svg:g fill="none" stroke="#703d29">
      ...
      <svg:g stroke-width=".6">
        ...
        />
        <svg:path d="M255.4 195.3a7.8 7.8 0 0 1 2.4 3.4" />
        <svg:path
          stroke-linecap="round"
        ...
        />
        <svg:path d="M385.1 224.1c-2.3.8-3.9 4.2-3.9 7.5a8.4 8.4 0 0 0 4 7.5" />
        <svg:path
          stroke-linecap="round"
        ...
        />
        <svg:path d="M234.6 260.7c2.1 0 4.1 2 4.1 4.2a3.9 3.9 0 0 1-1.4 3" />
        <svg:path
          stroke-linecap="round"
          d="M254 239.5a18 18 0 0 1 3.8 7.7m0 8.5a17.3 17.3 0 0 1-1.5 4 17.8 17.8 0 0 1-3.6 4.7"
        />
        <svg:path d="M254.3 224.3c1.8 1.5 3 3 3.5 4.8" />
        <svg:path
          stroke-linecap="round"
