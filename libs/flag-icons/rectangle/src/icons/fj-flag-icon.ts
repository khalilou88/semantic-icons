  ...
  template: `
    ...
    <svg:g stroke-miterlimit="4.8">
      ...
      <svg:g stroke-miterlimit="3">
        ...
        />
        <svg:path
          d="M433.1 214.5a3 3 0 0 0 .4 2q.5.8 1 .9.7 0 1.2-.6.3-.3.6-.4l.3.2.2-.2-.5-.3q-.5 0-.8.5t-1 .5q-.3 0-.8-.8a2 2 0 0 1-.3-1.7c.4-1.4 2.1-2.5 2.1-2.5l-.1-.3c-.1 0-1.9 1.2-2.3 2.7m-4.4 20.7q.2-.8 1.3-1.4c-.2 0 .6.6 1.3.6l.5-.3c.2.2 1.4 1.3 1.4 2.7q0 .5-.2.9l.3.1c.9-2.1-1.4-4-1.4-4h-.2l-.4.3c-.6 0-1.3-.6-1.3-.6q-1.4.6-1.6 1.6zm10.3-5.4c-.7.1-2.5.4-3.1 1.4q-.4.6-.1 1.2l.2.6c.6 1.6 1.2 3.2 1.9 3.6l.1-.3c-.6-.3-1.2-2-1.7-3.4l-.2-.6a1 1 0 0 1 0-1c.5-.7 2.2-1 3-1.1.4 0 .5 1.5.6 2.4h.3c-.1-1.4-.3-2.8-1-2.8"
        />
        <svg:path
          d="M433.9 231.4q-.4.6-.3.9c0 .1.2 4 2 4.8l.1-.3c-1.6-.7-1.8-4.5-1.8-4.6q0-.2.2-.6.4-.4 1.6 0l.1-.3q-1.3-.4-1.9 0z"
        />
        <svg:path
