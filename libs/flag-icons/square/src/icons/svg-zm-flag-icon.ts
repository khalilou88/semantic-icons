      ...
      >
        ...
        <g fill="#ef7d00" stroke="#000">
          ...
          <path
            ...
            stroke-linejoin="round"
            stroke-width=".9"
            d="M612.2 72.5s5.4-3.2 26.8-1.6c2.3.3 14.6-4.2 18.5-5.5 6.2-1.1 26-5.5 31.4-9.5 3.8-.5-1 7-5.8 8.7-5 2.3-23.4 8.7-30 7.8 7.9.1 3.5 6.5-9.5 3.4 6.2 3.5 4 4.1 4 4.1s-11 .6-14-1.9c7.4 2.8 4.4 3.8 4.4 3.8s-7.6.7-11-.9c5.3 1.6 2.6 2.6 2.6 2.6s-4.4.7-8-.6c-3.6-1.3-9.1-10.4-9.4-10.4"
          />
          <path
            stroke-linejoin="round"
            stroke-width=".9"
