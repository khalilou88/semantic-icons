...
@Component({
  ...
  template: `
    ...
    <svg:path
      fill="#006b00"
      d="M389.2 267.3s2.4-1 2.8-1.5a7 7 0 0 0 1.5-2.1c.2-.7-1.6-1.8-.7-3.4.6-.7 1.4-.8 2.7 0 1.3.9-1.2-2.6-2.6-2.7-1.3-.1-2.2 1-2.5.7-.4-.2 0 1-.5 1s1.1 1 1 1.5c0 .6 1.8 2.6 1.7 3.1-.1.5-2.8 3.2-3.4 3.4"
    />
    <svg:path
      fill="#ffc900"
      stroke="#ffc900"
    ...
    />
    <svg:path
      d="M453.7 221.6c0 .2-.2.4-.6.4-.3 0-.6-.2-.6-.4 0-.3.3-.5.6-.5.4 0 .6.2.6.5"
    />
    <svg:path
      fill="#fff"
      stroke="#000"
    ...
    />
    <svg:path
      d="M359.4 119.3c-.1.6-1 .8-2 .5-1-.3-1.7-1-1.5-1.6.2-.6 1-.8 2-.5 1 .3 1.7 1 1.5 1.6m2.9-.3c.2.7 1.1.9 2.1.6 1-.3 1.6-1 1.5-1.6-.2-.6-1.1-.8-2-.5-1 .3-1.7 1-1.6 1.6z"
    />
    <svg:path
      fill="#ff7000"
      stroke="#000"
    ...
    />
    <svg:path
      d="M318.5 221c0 .3-.3.6-.7.6-.4 0-.7-.3-.7-.6 0-.4.3-.7.7-.7.4 0 .7.3.7.7"
    />
    <svg:path
      fill="none"
      stroke="#2b2b2b"
    ...
    />
    <svg:path
      d="M336.3 218.1c0 1-.6 1.6-1.4 1.6-.8 0-1.4-.7-1.4-1.6 0-.9.6-1.6 1.4-1.6.8 0 1.4.7 1.4 1.6"
    />
    <svg:path
      fill="#2b2b2b"
      stroke="#2b2b2b"
