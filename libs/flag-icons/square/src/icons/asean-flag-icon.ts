...
@Component({
  ...
  imports: [],
  template: `
    <svg:path fill="#0039a6" stroke-width="4.18046" d="M0 0h512v512H0z" />
    <svg:circle cx="256" cy="256" r="153.6" fill="#fff" stroke-width="5.12" />
    <svg:circle
      cx="256"
      cy="256"
      r="146.4"
    ...
    <svg:g id="asean-a">
      <svg:path
        ...
        transform="translate(-128)scale(5.12)"
      />
      <svg:path
        fill="#f9e300"
