    ...
    >
      ...
      <g clip-path="url(#mp-a)" transform="translate(-256)scale(1.0321)">
        ...
        <path
          ...
          stroke-width="1.9"
          d="M340.9 114.8s7.4 6.4 6 16c-1.4 9.6-6.9 22.9-5.8 32.8.7 4 .4 11.1.4 11.1s-6.6-9.4-6.7-19.5 7.2-19.7 7.2-27.2-1.3-13.3-1.1-13.2zm-3.7 2.9s-9.6 9.2-10.8 18.1c-1 4.6-1.3 26-1.4 35.6l-1.7 18.6c-.3 4.2 7-7.2 7.5-16.4a281 281 0 0 1 .7-32.7c.9-4 .7-8.3 2-12.2z"
        />
        ...
        <path
          fill="#8c1800"
          fill-rule="evenodd"
          d="M588.8 412.4s-3.1-1.1 4.8-4.2c8-3.1 7.5-6.7 10-8.1 2.7-1.5 8.2-5.4 9.3-3.1s-5.8 6.8-7.4 7.3c-1.6.5-9.6 7.8-11.9 8.4-2.2.7-3.9.3-4.8-.3"
        />
        <path
          fill="none"
          stroke="#8c1800"
        ...
        <path
          fill="#8c1800"
          fill-rule="evenodd"
          d="M395.4 409.6s3-1.1-4.9-4.3c-7.8-3.1-7.4-6.7-10-8.2-2.5-1.5-8-5.5-9-3.2s5.7 7 7.3 7.5c1.6.5 9.5 7.9 11.7 8.6 2.3.6 3.9.3 4.9-.4"
        />
        <path
          fill="none"
          stroke="#8c1800"
