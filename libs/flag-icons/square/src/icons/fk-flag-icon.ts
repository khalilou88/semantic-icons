...
@Component({
  ...
  template: `
    ...
    <svg:g fill-rule="evenodd">
      ...
      <svg:path
        fill="#bcbcbc"
        d="M338 125.9v.3q0-1.1.3 1 .6 1.4.5 3.5a6 6 0 0 0 1.7-2.5c0-2.2-.4-2.2-2.5-2.3m9.8 32h.3c-.8 0-.3 0 1-.8 1-.7 1.7-1.6 3-2a11 11 0 0 1 3.4-2c.7-.3 1.3-.7 2-.3-.2 1.4-.5 2-1.7 2.6q-1 1.2-2.4 1.6c-.8.4-1.8.5-2.1 1.5-1.5.6-1.6.5-3.4-.6zm5.1 8 3-2.7a12 12 0 0 1 2.6-2.8q1.3-1.6 2.4-3l2.1-2.8c0 1.2-.1 2.8.3 3.5a6 6 0 0 1-.8 3.4c-.6 1-1 1.6-2.5 2.3-1.1.6-1.9.8-2.8 1.6l-2.5 1.4c-.7.3-.4.2-1.8-.8zm-8.3 6.4h.3c-.8 0-.4.1 1.1-.8q1.5-1.5 3.4-2.2a8 8 0 0 0 3.3-.8c.6-.2 1-.6 1.5 0 .9 1.1 1.1 1.5-.2 2.2a8 8 0 0 1-2.7 1.4c-.6.6-2 .6-3.3.8-1 0-1.6.2-2-.6l2.1.6c-1 0-1.6.2-3.5-.6m11.4 0v-.2q-.1 1.2.6-1.2c1-1.5 1.4-2.4 2.7-2.7.6-.8 1.6-1 3-1.4.4.8 0 1.8 0 2.8-.4 1-1.4 1.7-2 2.5-.8.6-1 1.1-2.4 1.4-1 0-.4 0-1.8-1.2z"
      />
      <svg:path
