...
@Component({
  ...
  template: `
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width=".4"
      d="M413 238.6c2.3 3.1 3 7.4 1.8 11.5h-3.6c1.5-5.3.6-10.4-5.7-11-9.5-1-20.5 20.8-37 23.5-5-6.9-4.7-20 1.5-26.2-3.2-11-9.9-23-14.5-28.1-3-.6-6.6-1-8.9-.8a33 33 0 0 1 15-15.4q1.3-2.3 2.7-4.4c.6-8.6 34.7-4.6 42 .7 0 9.6 3 41.5 6.6 50.2z"
    />
    <svg:path
