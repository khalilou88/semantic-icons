...
@Component({
  ...
  template: `
    ...
    <svg:g font-size="12">
      ...
      <svg:path
        fill="#d81126"
        d="M251.5 150.3s-14.1-6.8-27.4 3.2c0 0-24-3.4-25.9 19.6 0 .9-.2 2.6.3 3.2q.8.8.9 2c.1 1.2.3 1 .6 1.3q.2.4.5 1.9c0 1.2-.2 1.8 1 3s1.2 4.7 1.2 5.8.7 3.7 1.1 4.3c.6.6 1.5 2 1.5 3.3 0 1.1.5 4.5.2 5.3-.2 1 1.4 2 2.8 2.4 1.3.5 18.2 6 42.7 5.5 24.6-.3 33.5-1.7 43.7-5.3a2.5 2.5 0 0 0 1.7-2.7c-.2-.7 0-3 .4-3.5s3.4-5.2 2.7-6c-.6-1-.6-2.8 0-3.4.6-.8 2.4-4.3 2.7-5.7s.5-3.1 1.2-3.6c.5-.4.8-2.1.9-2.5a5 5 0 0 1 1.4-1.8s1-5.8.4-8.7c-.8-2.8-5.1-15.1-22.5-12.5 0 0-13-9.9-32.1-5.1"
      />
      <svg:path
        fill="none"
        stroke="#000"
