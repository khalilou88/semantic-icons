...
@Component({
  selector: 'svg[si-awsorganizations-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>AWS Organizations</svg:title>
    <svg:path
...
export class SiAwsorganizationsIcon implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.render.setAttribute(svg, 'fill', '#E7157B');
  }
}
