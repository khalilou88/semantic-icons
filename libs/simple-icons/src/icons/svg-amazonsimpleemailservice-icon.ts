...
@Component({
  selector: 'svg-amazonsimpleemailservice-icon',
  imports: [],
  template: `
    <svg
      [class]="_svgClass()"
...
export class SvgAmazonsimpleemailserviceIcon {
