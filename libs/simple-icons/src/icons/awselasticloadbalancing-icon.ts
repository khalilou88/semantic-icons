...
@Component({
  selector: 'svg[si-awselasticloadbalancing-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>AWS Elastic Load Balancing</svg:title>
    <svg:path
...
export class SiAwselasticloadbalancingIcon implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.render.setAttribute(svg, 'fill', '#8C4FFF');
  }
}
