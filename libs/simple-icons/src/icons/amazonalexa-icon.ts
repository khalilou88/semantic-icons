...
@Component({
  selector: 'svg[si-amazonalexa-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Amazon Alexa</svg:title>
    <svg:path
...
export class SiAmazonalexaIcon implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.render.setAttribute(svg, 'fill', '#00CAFF');
  }
}
