...
@Component({
  selector: 'svg[si-abbrobotstudio-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>ABB RobotStudio</svg:title>
    <svg:path
...
export class SiAbbrobotstudioIcon implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.render.setAttribute(svg, 'fill', '#FF9E0F');
  }
}
