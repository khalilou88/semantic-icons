...
@Component({
  ...
  template: `
    ...
    />
    <svg:path d="M8 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" />
    <svg:path d="M16.714 12.7a1 1 0 0 0 -1.417 -1.411l1.417 1.41z" />
...
export class SiCardboardsOffIcon implements OnInit {
